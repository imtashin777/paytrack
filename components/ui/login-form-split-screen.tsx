...
interface LoginFormSplitScreenProps {
...
/**
 * A responsive, split-screen login form component with Email, Password, Remember Me, and social login.
 */
export function LoginFormSplitScreen({
  logo,
  imageSrc,
  imageAlt,
  onSubmit,
